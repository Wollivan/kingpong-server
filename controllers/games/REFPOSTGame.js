...
async function addGame(req, res) {
  try {
    ...
    //Update the two players that just played each other

    const playerOneData = Game.find({ playerOneName });
    ...
    // assign both players either one or two, without mixing them up
    // I think this if statement could be halved in size///
